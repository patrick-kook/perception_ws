...
class Detect :
    ...
    def __init__(self) -> None:
        ...
        rospy.Subscriber('/odom', Odometry, self.carStateCb)
        ...
        # --- dyn params sub ---
        self.min_obs_size = 0.1
        self.max_obs_size = 0.6
        self.max_viewing_distance = 4
    ...
    def carStateCb(self, data):
        self.car_s, _ = self.calculate_frenet(data.pose.pose.position.x, data.pose.pose.position.y, self.waypoints)
