...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/patrick/perception_ws/src)
  set(perception_DEVEL_PREFIX /home/patrick/perception_ws/devel)
  ...
  set(perception_INSTALL_PREFIX /home/patrick/perception_ws/install)
...
if(NOT "/home/patrick/perception_ws/devel/include " STREQUAL " ")
  set(perception_INCLUDE_DIRS "")
  set(_include_dirs "/home/patrick/perception_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'icra_crew <icra_crew@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/patrick/perception_ws/src/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/patrick/perception_ws/devel/lib;/home/patrick/perception_ws/devel/lib;/opt/ros/noetic/lib)
...
set(perception_EXPORTED_TARGETS "perception_gencfg")
...
set(depends "roscpp;rospy;std_msgs;tf;sensor_msgs;realsense2_camera;cv_bridge;nav_msgs;std_srvs;image_transport;ddynamic_reconfigure;diagnostic_updater")
