        ...
        while not rospy.is_shutdown():
            ...
            if self.joy_mode == False:
                ...
                if closest_idx is not None and closest_dist is not None:
                    ...
                    self.target_point, self.target_color = self.get_target_point(lookahead_distance)
                    # 빨간색 감지 시 5초간 멈춤
                    self.check_and_pause(self.target_color)
            ...
            self.speed_pub.publish(speed_msg)        
                    ...
                    # drive_msg.drive.speed = self.compute_speed(self.target_color)
