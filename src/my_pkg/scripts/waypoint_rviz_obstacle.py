...
class WaypointsMarkerPublisher:
    def __init__(self):
        ...
        self.marker_pub = rospy.Publisher("/obs_waypoints_marker", Marker, queue_size=10)
        self.posearray_pub = rospy.Publisher("/obstacle_waypoints", PoseArray, queue_size=10)

        # 파일 경로 설정
        self.file_path = "/home/patrick/trajectory_generator/f1tenth-racing-stack-ICRA22/trajectory_generator/outputs/1001/centerline.csv"
    ...
    def publish_markers(self):
        ...
        for segment in segments:
            ...
            max_curvature = 1 # 예시로 최대 곡률을 설정
            min_curvature = 1  # 예시로 최소 곡률을 설정
            ...
            for waypoint in segment:
                world_x, world_y = waypoint[0], waypoint[1]
