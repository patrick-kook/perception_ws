...
class WaypointsMarkerPublisher:
    def __init__(self):
        ...
        self.marker_pub = rospy.Publisher(
            "/stan_waypoints_marker", Marker, queue_size=10
        )
        self.posearray_pub = rospy.Publisher(
            "/stan_waypoints", PoseArray, queue_size=10
        )

        # 파일 경로 설정
        self.file_path = "/home/patrick/Downloads/0923_stan.txt"
        ...
        self.resolution = 0.080000
        self.origin = [-50.924998, -50.224998, 0.000000]
    ...
    def publish_markers(self):
        ...
        for segment in segments:
            ...
            max_curvature = 0.03  # 예시로 최대 곡률을 설정
